...
/**
 * Test class for class {@link CCIID22B}.
 *
 * @author Philip Helger
 */
public final class CCIID22BTest
{
  @Test
  public void testGetXSDResource ()
  {
    final ICommonsList <ClassPathResource> aXSDs = new CommonsArrayList <> (CCIID22B.getXSDResourceCII (),
                                                                            CCIID22B.getXSDResourceCDAR ());
