...
<!-- ph-badge-start -->
[![Sonatype Central](https://maven-badges.sml.io/sonatype-central/com.helger.cii/ph-cii-parent-pom/badge.svg)](https://maven-badges.sml.io/sonatype-central/com.helger.cii/ph-cii-parent-pom/)
[![javadoc](https://javadoc.io/badge2/com.helger.cii/ph-cii-testfiles/javadoc.svg)](https://javadoc.io/doc/com.helger.cii/ph-cii-testfiles)
...
v4.1.3 - 2026-09-22
* Switched the CII D22B XSDs to the "uncoupled" variant, so that all CII and CDAR versions except D16A.1 use it.
  UN/CEFACT published no uncoupled variant for D16A.1, so it stays coupled
