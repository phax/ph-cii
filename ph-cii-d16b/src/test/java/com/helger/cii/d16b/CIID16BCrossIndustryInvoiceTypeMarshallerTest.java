...
/**
 * Test class for class {@link CIID16BCrossIndustryInvoiceTypeMarshaller}.
 *
 * @author Philip Helger
 */
public final class CIID16BCrossIndustryInvoiceTypeMarshallerTest
{
  private static final Logger LOGGER = LoggerFactory.getLogger (CIID16BCrossIndustryInvoiceTypeMarshallerTest.class);
  ...
  public void testReadAndWriteInvoice ()
  {
    ...
    m.setNamespaceContext (new MapBasedNamespaceContext (CIID16BNamespaceContext.getInstance ()).addMapping ("bla",
                                                                                                             CCIID16B.XML_SCHEMA_RSM_NAMESPACE_URL));

    final String sFilename = MockCIID16BTestDocuments.getTestCrossIndustryInvoices ().get (0);
