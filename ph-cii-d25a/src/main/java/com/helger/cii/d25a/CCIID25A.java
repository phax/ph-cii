...
/**
 * Constants for CII D25A handling.
 *
 * @author Philip Helger
 */
@Immutable
public final class CCIID25A
{
  /** The classpath relative directory where the main XSDs reside */
  public static final String SCHEMA_DIRECTORY = "external/schemas/d25a/";

  public static final String XSD_PATH_CII = SCHEMA_DIRECTORY + "cii/CrossIndustryInvoice_100pD25A.xsd";
  ...
  private static final CCIID25A INSTANCE = new CCIID25A ();
  ...
  {
    return CCIID25A.class.getClassLoader ();
  }
